...
const PlaceDetails = ({place, selected, refProp}) => {
  ...
  console.log({selected , place , refProp})
      ...
      <CardMedia
        ...
        <CardContent>
          ...
          {place?.cuisine?.map(({name}) => (
            ...
            <CardActions>
              <Button size='small' color='secondary' onClick={() => window.open(place.web_url, '_blank')}>Trip Advisor</Button>
              <Button size='small' color='secondary' onClick={() => window.open(place.website, '_blank')}>Website</Button>
